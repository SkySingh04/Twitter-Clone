    ...
    <div className="bg-black text-white">
        ...
        <div className="max-w-2xl mx-auto  py-8">
            <div className="text-left mt-16">
                ...
                <p className="p-[2px] text-xl font-bold text-blue-600">{user.username}</p>
                ...
                <svg
                    ...
                    <span className="relative bottom-[19px] left-[25px]">Joined at {user.joinedAt.toDate().toDateString()}</span>
                </p>
                <p> <span className="text-gray-300">{user.followers}</span> Followers    <span className="text-gray-300"> {user.following} </span> Following</p>
            </div>
