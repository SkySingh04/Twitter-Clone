...
const Input = () => {
  return (
    <>
    <header>
   <nav className=" fixed top-0 w-3/4 bg-black text-white p-4 flex justify-center ">
...
<main>
<section>
<div className="h-64 w-screen bg-black-200  justify-start h-screen flex items-center justify-center">
            <img src="/logo.jpg"></img>
            <p className='text-2xl text-gray-600 ml-4'>What is Happening?!</p>
                    </div>
